...
<div class="w-[400px] nx-auto">
    ...
    <ul class="mt-4">
        <li v-for="todo in todos"
                class="border border-green-400 rounded shadow p-2 mb-3 bg-green-100 flex gap-2">
            <div class="border border-green-500 rounded-full w-[30px h-[30px] p-1 text-center bg-green-700 text-white"></div>
